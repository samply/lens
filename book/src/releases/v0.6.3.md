...
- Charts now support sorting by value or alphabetically with visual toggle buttons that indicate sort direction. This feature is enabled by default and can be disabled by setting the `enableSorting` prop of the [Lens Chart](../components/chart.md) component to `false`.
