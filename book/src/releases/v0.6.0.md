...
The treedata prop previously used to provide the catalogue to the HTML component has been removed. The catalogue is now set explicitly via the setCatalogue(...) function.
