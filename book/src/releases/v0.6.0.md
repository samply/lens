...
The `treeData` prop previously used to provide the catalogue to Lens has been removed. Use the [setCatalogue](https://samply.github.io/lens/docs/functions/setCatalogue.html) function instead.
