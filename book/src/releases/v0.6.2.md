...
- Ability to hide failed sites: Added the [`hideFailedSite`](https://samply.github.io/lens/docs/functions/hideFailedSite.html) function to allow applications to hide sites that have failed from the result summary and result table. Consider using this function in your result handling logic to improve user experience when dealing with site failures. See the [Showing results](../guide/results.md#passing-results-to-lens) guide for an example.
