...
// EHDS2/ECDC uses CareTeam resources to represent laboratories, because cqfm-populationBasis
// needs to have the subject attribute to calculate the population, and CareTeam just happens
// to have that attribute.
//
// The CQL in this measure depends on function(s) defined in EHDS2_UTIL
export const ehds2LaboratoryMeasure = {
    key: "laboratories",
    measure: {
        code: {
            text: "laboratories",
...
// EHDS2/ECDC uses CareTeam resources to represent hospitals, because cqfm-populationBasis
// needs to have the subject attribute to calculate the population, and CareTeam just happens
// to have that attribute.
//
// The CQL in this measure depends on function(s) defined in EHDS2_UTIL
export const ehds2HospitalMeasure = {
    key: "hospitals",
    measure: {
        code: {
            text: "hospitals",
