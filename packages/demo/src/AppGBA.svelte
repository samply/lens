            ...
            datasets: [
                {
                    label: [],
                    data: [
                        12, 100, 30, 5, 12, 19, 3, 12, 19, 3, 12, 19, 3, 12, 12,
                        19, 3, 1, 12, 100, 30, 5, 12, 19, 3, 12, 19, 3, 12, 19,
                        3, 12, 12, 19, 3, 1,
                    ],
                },
            ],
...
<header>
    <div class="container">
        <img src="../public/GBN_logo.svg" alt="German Biobank Node" />
        <menu class="menu">
            <a href="/about">About Us</a>
            <a href="/contact">Contact</a>
            <a href="https://login.bbmri-eric.eu/oidc/endsession">Logout</a>
        </menu>
    </div>
        ...
        <div class="charts">
            ...
            <div class="chart-wrapper chart-gender-distribution">
                <lens-chart
                    ...
                    backgroundHoverColors={JSON.stringify(
                        chartBackgroudnColors,
                    )}
                />
            </div>
...
<footer>
    ...
    <a href="https://www.npmjs.com/package/@samply/lens"
        >made with &#10084; & samply-lens</a
    >
    ...
    <div class="img-container">
        <img
            src="../public/logo_ce-en-rvb-lr.jpg"
